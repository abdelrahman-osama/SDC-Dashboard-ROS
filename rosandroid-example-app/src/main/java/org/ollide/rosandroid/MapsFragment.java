...
//                        MainActivity.gucPlaces = gucPlaces;
    ...
    private void getTripFromServer() {
        ...
        String tripUrl = "https://sdc-trip-car-management.herokuapp.com/car/find/hadwa";
...
//                        }
    ...
    public void createTrip(){
        String createTripUrl = "https://sdc-trip-car-management.herokuapp.com/car/create/trip";
        if(mLastLocation!=null) {
...
//        requestTrip.setTabletFcmToken(MyFirebaseInstanceIDService.getToken());
    ...
    public void updateFCMServer(){
        ...
        String newTokenUrl = "https://sdc-trip-car-management.herokuapp.com/car/admin/token/tablet";
